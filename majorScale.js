...
const translations = {
    en: {
        ...
        start: 'START',
        features: '✨ Features',
        feature1: '<strong>15 Major Scales</strong> - Practice all major scales from C to C♭',
    ...
    pl: {
        ...
        start: 'START',
        features: '✨ Funkcje',
        feature1: '<strong>15 Gam Durowych</strong> - Ćwicz wszystkie gamy durowe od C do C♭',
...
const scalesData = {
    ...
    'F': {chords: ['F', 'Gm', 'Am', 'B♭', 'C', 'Dm', 'Edim'], accidentals: '1♭'},
    'B♭': {chords: ['B♭', 'Cm', 'Dm', 'E♭', 'F', 'Gm', 'Adim'], accidentals: '2♭'},
    'E♭': {chords: ['E♭', 'Fm', 'Gm', 'A♭', 'B♭', 'Cm', 'Ddim'], accidentals: '3♭'},
    'A♭': {chords: ['A♭', 'B♭m', 'Cm', 'D♭', 'E♭', 'Fm', 'Gdim'], accidentals: '4♭'},
    'D♭': {chords: ['D♭', 'E♭m', 'Fm', 'G♭', 'A♭', 'B♭m', 'Cdim'], accidentals: '5♭'},
    'G♭': {chords: ['G♭', 'A♭m', 'B♭m', 'C♭', 'D♭', 'E♭m', 'Fdim'], accidentals: '6♭'},
    'C♭': {chords: ['C♭', 'D♭m', 'E♭m', 'F♭', 'G♭', 'A♭m', 'Bdim'], accidentals: '7♭'}
};
